...
export function WhyChoosePage({ content }: { content: WhyChooseContent }) {
  return <main className="why-page">
    ...
    <section className="why-intro container"><Reveal><Image src="/assets/svtech/why/customer-understanding.jpg" alt="Đội ngũ SVTECH" width={1024} height={671}/></Reveal><Reveal className="why-intro-copy" delay={100}><h2>{content.introTitle}</h2>{content.introParagraphs.map(text=><p key={text}>{text}</p>)}</Reveal></section>
