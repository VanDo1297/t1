...
export default async function PlaceholderPage({ params }: PageProps<"/[...slug]">) {
  ...
  return <><Header /><main className="placeholder-page"><div className="placeholder-orb" /><span>SVTECH</span><h1>{title}</h1><p>Nội dung trang đang được hoàn thiện. Điều hướng và trải nghiệm giao diện đã sẵn sàng để phát triển ở giai đoạn tiếp theo.</p><Link className="primary-button" href="/">Về trang chủ <Icon name="arrow" /></Link></main><Footer /></>;
}
